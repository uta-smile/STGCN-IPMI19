...
flags.DEFINE_string(
    "train_list",
    "/mnt/data/m2cai/m2cai_tool/video_features_adam_290/train_video.pkl",
    "Train data set list.")
flags.DEFINE_string(
    "valid_list",
    "/mnt/data/m2cai/m2cai_tool/video_features_adam_290/valid_video.pkl",
    "Valid data set list.")
flags.DEFINE_string(
    "test_list",
    "/mnt/data/m2cai/m2cai_tool/video_features_adam_290/test_video.pkl",
    "Test data set list.")
...
flags.DEFINE_string("save_model_path", "saved/saved_video_graph_11",
                    "Path to save models.")
